...
def ecg(
    ...
    Arguments:
        ...
        task: The task to train or eval on. Should be "HFpEF".
    ...
    For training, set `task="HFpEF"` and overwrite any hyperparameters in `cfg_updates`.

    For evaluation, set `mode="eval"` and set `eval_model_path`, `eval_model_name`, 
    and `use_label_file_for_eval` as necessary.
    """
